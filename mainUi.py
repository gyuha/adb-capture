...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnConfigLoad = QtWidgets.QPushButton(self.centralwidget)
        self.btnConfigLoad.setObjectName("btnConfigLoad")
        self.horizontalLayout_4.addWidget(self.btnConfigLoad)
        self.btnConfigSave = QtWidgets.QPushButton(self.centralwidget)
        self.btnConfigSave.setObjectName("btnConfigSave")
        self.horizontalLayout_4.addWidget(self.btnConfigSave)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnConfigLoad.setText(_translate("MainWindow", "읽기"))
        self.btnConfigSave.setText(_translate("MainWindow", "저장"))
        self.btnConfigAdd.setText(_translate("MainWindow", "명령어 추가"))
        self.pushButton.setText(_translate("MainWindow", "명령어 삭제"))
